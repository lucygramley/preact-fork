...
export const Router = props => {
    ...
    return h(RouterContext.Provider, { children: props.children, value: router });
};
export const Route = props => {
    ...
    if (dir == null)
        return null;
    if (props.match !== '*' && dir !== props.match)
        return null;
    const children = useMemo(() => {
        if (props.component)
            return h(props.component, { key: dir, route: dir });
        if (props.render)
            return props.render(dir);
        return props.children;
    }, [props.component, props.render, props.children, dir]);
    const innerRouter = useMemo(() => ({
        ...router,
        match: [...router.match, dir],
        path: subpath
    }), [router.match, dir, subpath.join('/')]);
    return h(RouterContext.Provider, { children: children, value: innerRouter });
};
export const Link = props => {
    ...
    const activeClass = useMemo(() => {
        ...
        if (isMatch)
            return props.active === true ? 'active' : props.active;
    ...
    const getHref = useCallback(() => {
        if (props.href == null || props.href[0] === '/')
            return props.href;
    ...
    return (h("a", { ...props, class: classes.join(' '), href: getHref(), onClick: handleClick }));
};
